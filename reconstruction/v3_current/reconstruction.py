...
# =========================================================
# PHASE 2.4 POSE GRAPH STABILIZATION
# =========================================================
        ...
        for i in range(total_images):
            ...
            for j in range(
                ...
                try:
                    ...
                    print(f"RAW TRIANGULATED = {len(points_3d)}")
                    ...
                    print(f"AFTER ANGLE FILTER = {len(points_3d)}")
                ...
                print(f"AFTER DEPTH FILTER = {len(points_3d)}")
                ...
                if len(points_3d) > 20:
                    ...
                    print(f"AFTER DISTANCE FILTER = {len(points_3d)}")
                ...
                if len(points_3d) > 10:
                    ...
                    print(f"AFTER FINAL REPROJECTION = {len(points_3d)}")
...
#        )
        ...
        camera_confidence_scores = []

        camera_pose_validity = []
        ...
        print("VALID IDS COUNT:", len(valid_image_ids))
        print("CAMERA POSITIONS COUNT:", len(camera_positions))
        for idx, pos in enumerate(camera_positions):
            print(
               f"Camera {valid_image_ids[idx]} shape = {np.array(pos).shape}"
            )
                # =====================================================
            ...
            camera_confidence_scores.append(1.0)

            camera_pose_validity.append(True)

            # =========================================================
            # CAMERA POSITION ARRAY
            # =========================================================
        print("\n==============================")
        print("CAMERA POSE DEBUG")
        print("==============================")
        print("Total Images:", total_images)
        print("Recovered Cameras:", len(camera_positions_dict))
        print("Camera IDs:", sorted(camera_positions_dict.keys()))
        print("==============================\n")
        camera_positions = np.array(
            camera_positions
        )

        print("CAMERAS RIGHT AFTER ARRAY:", len(camera_positions))
        print("CAMERAS BEFORE FILTERS:", len(camera_positions))
...
#     )
        ...
        print("CAMERA SMOOTHING DISABLED")
            # =========================================================
            # GLOBAL DRIFT SUPPRESSION
            # =========================================================
...
#
#                valid_camera_mask = (
#                    distances < drift_threshold
#                )
#
#                camera_positions = camera_positions[
#                    valid_camera_mask
#                ]
        print("AFTER DRIFT FILTER:", len(camera_positions))
            # =========================================================
...
#                ):
#
#                    prev_pos = continuity_filtered[-1]
#
#                    current_pos = camera_positions[idx]
#
...
#                    if movement < 2.0:
#
#                        continuity_filtered.append(
#                            current_pos
#                        )
#
#                camera_positions = np.a#rray(
#                    continuity_filtered
#                )
#        print("AFTER CONTINUITY FILTER:", len(camera_positions))
# =========================================================
# CAMERA GRAPH NORMALIZATION
# =========================================================
...
#
#         camera_positions = (
#             camera_positions / scale
#         )

        print("CAMERA NORMALIZATION DISABLED")
            # =========================================================
        ...
        for idx, p in enumerate(pair_logs):
            print(
                f"PAIR_LOG[{idx}] TYPE = {type(p)}"
            )
        ...
        pose_graph_quality = np.mean(
                camera_confidence_scores
            ) if len(camera_confidence_scores) > 0 else 0

        global_quality_score = (

                successful_pairs_ratio * 40 +

                pose_graph_quality * 30 +
        ...
        if progress_callback:
            ...
            print("\n===== FIRST 10 CAMERA ROTATIONS =====")

            for idx in sorted(global_rotations.keys())[:10]:

                R = global_rotations[idx]
                ...
                print(
                    f"Camera {idx} Rotation = {angle:.2f}"
                )

            print("==============================\n")           
            print("\n==============================")
            print("POSE GRAPH INFO")
            print("==============================")
            print("Recovered Cameras:", len(camera_positions))
            print("Pose Graph Edges:", len(pose_graph_edges))
            print("==============================\n")
        ...
        print(
            f"\nLoaded COLMAP model:"
            f"\nCameras: {len(camera_positions)}"
            f"\nPoints: {len(sparse_points)}"
        )            
        ...
        print("\n===== DENSE INPUT DEBUG =====")
        print("Valid Image IDs:", valid_image_ids)
        print("Images passed to dense:", len(images))
        print("Camera poses:", len(camera_positions))
        print("=============================\n")
        print("CAMERAS BEFORE DENSE:", len(camera_positions))
        print("VALID IMAGE IDS:", len(valid_image_ids))
        ...
        return (
            ...
            processing_time,
            {
                    ...
                    "valid_camera_poses":
                        int(np.sum(camera_pose_validity)),
